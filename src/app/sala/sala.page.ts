...
export class SalaPage implements OnInit {
  ...
  constructor(public  route   : ActivatedRoute, 
    ...
    this.usuario.get('/elementos/listar/sensor/5cac19d6f1b241090c95e538').subscribe((data: any) => {
    ...
    this.usuario.get('/elementos/listar/luz/5cac19d6f1b241090c95e538').subscribe((data: any) => {
